...
All QEMU work lives in the [`mithro/qemu`](https://github.com/mithro/qemu) fork and is pulled into the program as a
...
[`d16-ast2050-machine`](https://github.com/mithro/qemu/tree/d16-ast2050-machine)).
Models the ARM926EJ-S core, SCU (with unlock key), SDRAM
...
[`ns9360-machine`](https://github.com/mithro/qemu/tree/ns9360-machine)); boots
the U-Boot port under a serial-socket smoke test.
